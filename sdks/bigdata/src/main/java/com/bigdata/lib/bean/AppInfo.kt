...
//    var installtime: String? = null//安装时间
//    var installtime_utc: String? = null //
    var kT2wAsVN: String? = null//
    var k1gCFs: String? = null//最后更新时间
    var BUjkAjl: Int = -1 // 是否是预装 0:预装 1:非预装
    var buWMs: String? = null// app版本
    var uh9U:String? = null //设备id
