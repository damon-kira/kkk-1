package com.kira.ui.language.php.provider
...
class PhpProvider private constructor() : SuggestionProvider {

    companion object {

        private var phpProvider: PhpProvider? = null

        fun getInstance(): PhpProvider {
            return phpProvider ?: PhpProvider().also {
                phpProvider = it
            }
        }
    }
