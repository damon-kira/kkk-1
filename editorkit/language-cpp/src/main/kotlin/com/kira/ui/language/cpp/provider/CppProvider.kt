package com.kira.ui.language.cpp.provider
...
class CppProvider private constructor() : SuggestionProvider {

    companion object {

        private var cppProvider: CppProvider? = null

        fun getInstance(): CppProvider {
            return cppProvider ?: CppProvider().also {
                cppProvider = it
            }
        }
    }
