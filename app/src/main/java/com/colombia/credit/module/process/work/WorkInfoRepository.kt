...
// 上传工作信息
class WorkInfoRepository @Inject constructor() : BaseProcessRepository<RspWorkInfo, ReqWorkInfo>() {
    ...
    override fun getInfo(): LiveData<BaseResponse<RspWorkInfo>> =
        ApiServiceLiveDataProxy.request(RspWorkInfo::class.java) {
            apiService.getWorkInfo()
        }
