package com.kira.learning.xml.view.expandview
...
class ExpandableCardView @JvmOverloads constructor(
    ...
    private lateinit var card_arrow: ImageButton
    private lateinit var card_icon: ImageButton
    private lateinit var card_header: RelativeLayout
    private lateinit var card_layout: CardView
    private lateinit var card_container: LinearLayout
    private lateinit var card_stub: ViewStub
    ...
    private fun initView(context: Context) {
        ...
        card_stub = findViewById(R.id.card_stub)
    }

    private fun initAttributes(context: Context, attrs: AttributeSet) {
        context.withStyledAttributes(/* set = */ attrs, /* attrs = */
            R.styleable.ExpandableCardView
        ) {
            this@ExpandableCardView.typedArray = this
            title = getString(R.styleable.ExpandableCardView_title_expandableCardView)
            iconDrawable =
                getDrawable(R.styleable.ExpandableCardView_icon_expandableCardView)
            innerViewRes =
                getResourceId(R.styleable.ExpandableCardView_inner_view, View.NO_ID)
