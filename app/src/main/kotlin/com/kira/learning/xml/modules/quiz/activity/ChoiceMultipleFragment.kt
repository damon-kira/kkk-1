package com.kira.learning.xml.modules.quiz.activity
...
class ChoiceMultipleFragment : BaseFunctionFragment() {
    ...
    private val mBinding by binding(FragmentChoiceMultipleBinding::inflate)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        GlideUtils.loadCornerImageFromUrl(
            view.context,
            mData?.attrs?.questionText ?: "",
            mBinding.ivChoiceMultipleImage,
            4.dp(),
...
//                loadImage(imageUri)
    ...
    companion object {
        fun newInstance(id: String): ChoiceMultipleFragment {
            return ChoiceMultipleFragment().apply {
