...
package com.kira.ui.language.visualbasic.provider
...
class VisualBasicProvider private constructor() : SuggestionProvider {

    companion object {

        private var visualBasicProvider: VisualBasicProvider? = null

        fun getInstance(): VisualBasicProvider {
            return visualBasicProvider ?: VisualBasicProvider().also {
                visualBasicProvider = it
            }
        }
    }
