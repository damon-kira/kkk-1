...
import com.kira.quickupload.data.HttpUploadTaskParameters
import com.kira.quickupload.data.NameValue
import com.kira.quickupload.extensions.addHeader
import com.kira.quickupload.extensions.isValidHttpUrl
 ...
 *
 */
abstract class GeneralUploadRequest<B : GeneralUploadRequest<B>>(
    context: Context,
    serverUrl: String
) :
