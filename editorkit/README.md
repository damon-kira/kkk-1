...
[![MavenCentral](https://img.shields.io/maven-central/v/com.kira.ui/editorkit?label=Download)](https://repo1.maven.org/maven2/com/blacksquircle/ui/editorkit/)
...
dependencies {
  ...
  implementation 'com.kira.ui:editorkit:2.9.0'
}
```
...
```xml
<com.kira.ui.editorkit.widget.TextProcessor
...
```xml
<com.kira.ui.editorkit.widget.TextScroller
...
```kotlin
import com.kira.ui.editorkit.exception.LineException
...
[![MavenCentral](https://img.shields.io/maven-central/v/com.kira.ui/language-base?label=Download)](https://repo1.maven.org/maven2/com/blacksquircle/ui/language-base/)
...
dependencies {
  ...
  implementation 'com.kira.ui:language-actionscript:2.9.0'
  implementation 'com.kira.ui:language-base:2.9.0' // for custom language
  implementation 'com.kira.ui:language-c:2.9.0'
  implementation 'com.kira.ui:language-cpp:2.9.0'
  implementation 'com.kira.ui:language-csharp:2.9.0'
  implementation 'com.kira.ui:language-css:2.9.0'
  implementation 'com.kira.ui:language-fortran:2.9.0'
  implementation 'com.kira.ui:language-go:2.9.0'
  implementation 'com.kira.ui:language-groovy:2.9.0'
  implementation 'com.kira.ui:language-html:2.9.0'
  implementation 'com.kira.ui:language-ini:2.9.0'
  implementation 'com.kira.ui:language-java:2.9.0'
  implementation 'com.kira.ui:language-javascript:2.9.0'
  implementation 'com.kira.ui:language-json:2.9.0'
  implementation 'com.kira.ui:language-julia:2.9.0'
  implementation 'com.kira.ui:language-kotlin:2.9.0'
  implementation 'com.kira.ui:language-latex:2.9.0'
  implementation 'com.kira.ui:language-lisp:2.9.0'
  implementation 'com.kira.ui:language-lua:2.9.0'
  implementation 'com.kira.ui:language-markdown:2.9.0'
  implementation 'com.kira.ui:language-php:2.9.0'
  implementation 'com.kira.ui:language-plaintext:2.9.0'
  implementation 'com.kira.ui:language-python:2.9.0'
  implementation 'com.kira.ui:language-ruby:2.9.0'
  implementation 'com.kira.ui:language-rust:2.9.0'
  implementation 'com.kira.ui:language-shell:2.9.0'
  implementation 'com.kira.ui:language-smali:2.9.0'
  implementation 'com.kira.ui:language-sql:2.9.0'
  implementation 'com.kira.ui:language-toml:2.9.0'
  implementation 'com.kira.ui:language-typescript:2.9.0'
  implementation 'com.kira.ui:language-visualbasic:2.9.0'
  implementation 'com.kira.ui:language-xml:2.9.0'
  implementation 'com.kira.ui:language-yaml:2.9.0'
}
```
...
dependencies {
  ...
  implementation 'com.kira.ui:language-base:2.9.0'
}
```
