package com.kira.ui.language.fortran.styler

import com.kira.ui.language.base.model.TextStructure
import com.kira.ui.language.base.styler.LanguageStyler
import com.kira.ui.language.fortran.lexer.FortranLexer
import com.kira.ui.language.fortran.lexer.FortranToken
...
class FortranStyler private constructor() : LanguageStyler {
    ...
    companion object {
        ...
        private val METHOD =
            Pattern.compile("(?<=(function|subroutine)) (\\w+)", Pattern.CASE_INSENSITIVE)
    ...
    override fun execute(structure: TextStructure): List<SyntaxHighlightResult> {
        ...
        while (matcher.find()) {
            ...
            val syntaxHighlightResult =
                SyntaxHighlightResult(tokenType, matcher.start(), matcher.end())
