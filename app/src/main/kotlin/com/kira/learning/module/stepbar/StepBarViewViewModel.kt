...
internal class ExampleViewViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun activeThumbDropdownSelected(selectionPosition: Int) {
        when (selectionPosition) {
            ...
            2 -> _events.value =
                Event.ActiveThumbSetToCustom(getDrawable(R.drawable.shape_star_red))
        }
    }
    ...
    fun filledThumbDropdownSelected(selectionPosition: Int) {
        when (selectionPosition) {
            ...
            1 -> _events.value =
                Event.FilledThumbSetToCustom(getDrawable(R.drawable.shape_star_red))
        }
    }
    ...
    fun unfilledThumbDropdownSelected(selectionPosition: Int) {
        when (selectionPosition) {
            ...
            1 -> _events.value =
                Event.UnfilledThumbSetToCustom(getDrawable(R.drawable.shape_star_blue))
        }
    }
