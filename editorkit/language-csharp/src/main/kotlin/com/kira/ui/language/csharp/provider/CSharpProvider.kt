...
package com.kira.ui.language.csharp.provider
...
class CSharpProvider private constructor() : SuggestionProvider {

    companion object {

        private var csharpProvider: CSharpProvider? = null

        fun getInstance(): CSharpProvider {
            return csharpProvider ?: CSharpProvider().also {
                csharpProvider = it
            }
        }
    }
