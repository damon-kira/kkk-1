package com.kira.learning.xml.view.textview
...
import com.util.lib.shape.ShapeStyle
        ...
        if (mTextStrokeEnable && mTextStrokeWidth > 0) {
            mBorderText = object : AppCompatTextView(context, attrs) {
                ...
                override fun onDraw(canvas: Canvas) {
                    canvas.withTranslation(mLeftDrawableWidth, mTopDrawableWidth) {
                        super.onDraw(this)
                    }
                }
...
//        mBorderText?.layoutParams = params
    ...
    private fun setSpanText() {
        ...
        val span = SpannableImpl().init(str).color(mSpanTextColor, *spanText)
        if (mSpanTextSize > 0) {
