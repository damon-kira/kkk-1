...
import com.kira.quickupload.extensions.acquirePartialWakeLock
import com.kira.quickupload.extensions.getUploadTask
import com.kira.quickupload.extensions.getUploadTaskCreationParameters
import com.kira.quickupload.extensions.safeRelease
import com.kira.quickupload.tools.logger.Logger
import com.kira.quickupload.observer.task.TaskCompletionNotifier
import com.kira.quickupload.observer.task.UploadObserverBase
import com.kira.quickupload.observer.task.UploadTaskObserver
...
class UploadService : Service(), CoroutineScope by MainScope() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val taskCreationParameters =
            intent.getUploadTaskCreationParameters() ?: return shutdownIfThereArentAnyActiveTasks()
