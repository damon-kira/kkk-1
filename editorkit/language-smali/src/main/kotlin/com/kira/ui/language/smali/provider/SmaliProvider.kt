...
package com.kira.ui.language.smali.provider
...
class SmaliProvider private constructor() : SuggestionProvider {

    companion object {

        private var smaliProvider: SmaliProvider? = null

        fun getInstance(): SmaliProvider {
            return smaliProvider ?: SmaliProvider().also {
                smaliProvider = it
            }
        }
    }
