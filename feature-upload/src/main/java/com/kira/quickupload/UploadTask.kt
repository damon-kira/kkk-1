...
import com.kira.quickupload.UploadConfiguration.semaphore
import com.kira.quickupload.data.UploadFile
import com.kira.quickupload.data.UploadInfo
import com.kira.quickupload.data.UploadTaskParameters
import com.kira.quickupload.exceptions.NoNetworkException
import com.kira.quickupload.exceptions.UploadError
import com.kira.quickupload.exceptions.UserCancelledUploadException
    ...
    protected fun onResponseReceived(response: ServerResponse) {
        ...
        if (response.isSuccessful) {
            ...
            theObserver {
                scope.launch(Dispatchers.Main) {
                    onError(
                        uploadInfo, UploadError(response)
                    )
                }
