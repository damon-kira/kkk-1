...
package com.kira.ui.language.julia.provider
...
class JuliaProvider private constructor() : SuggestionProvider {

    companion object {

        private var juliaProvider: JuliaProvider? = null

        fun getInstance(): JuliaProvider {
            return juliaProvider ?: JuliaProvider().also {
                juliaProvider = it
            }
        }
    }
