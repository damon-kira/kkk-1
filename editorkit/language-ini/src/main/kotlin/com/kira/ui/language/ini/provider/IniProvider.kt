package com.kira.ui.language.ini.provider
...
class IniProvider private constructor() : SuggestionProvider {

    companion object {

        private var iniProvider: IniProvider? = null

        fun getInstance(): IniProvider {
            return iniProvider ?: IniProvider().also {
                iniProvider = it
            }
        }
    }
