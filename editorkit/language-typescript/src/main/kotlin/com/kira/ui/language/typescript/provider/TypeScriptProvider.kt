...
package com.kira.ui.language.typescript.provider
...
class TypeScriptProvider private constructor() : SuggestionProvider {

    companion object {

        private var typeScriptProvider: TypeScriptProvider? = null

        fun getInstance(): TypeScriptProvider {
            return typeScriptProvider ?: TypeScriptProvider().also {
                typeScriptProvider = it
            }
        }
    }
