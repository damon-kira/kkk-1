package com.kira.ui.language.actionscript.provider
...
class ActionScriptProvider private constructor() : SuggestionProvider {

    companion object {

        private var actionScriptProvider: ActionScriptProvider? = null

        fun getInstance(): ActionScriptProvider {
            return actionScriptProvider ?: ActionScriptProvider().also {
                actionScriptProvider = it
            }
        }
    }
