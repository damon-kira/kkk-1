package com.kira.ui.language.lua.provider
...
class LuaProvider private constructor() : SuggestionProvider {

    companion object {

        private var luaProvider: LuaProvider? = null

        fun getInstance(): LuaProvider {
            return luaProvider ?: LuaProvider().also {
                luaProvider = it
            }
        }
    }
