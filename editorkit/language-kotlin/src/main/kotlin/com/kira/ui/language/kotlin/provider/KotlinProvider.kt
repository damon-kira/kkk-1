...
package com.kira.ui.language.kotlin.provider
...
class KotlinProvider private constructor() : SuggestionProvider {

    companion object {

        private var kotlinProvider: KotlinProvider? = null

        fun getInstance(): KotlinProvider {
            return kotlinProvider ?: KotlinProvider().also {
                kotlinProvider = it
            }
        }
    }
