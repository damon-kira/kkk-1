...
import com.colombia.credit.module.ocr.CutOutPhotoActivity;
 ...
 */
public class TakePhoteActivity2 extends AppCompatActivity {
...
//                preview.setSurfaceProvider(mBinding.preview.getSurfaceProvider());
    ...
    private void launchActivity(Uri uri) {
        String path = UriUtils.INSTANCE.getFileFromUri(this, uri);
        if (path == null) {
