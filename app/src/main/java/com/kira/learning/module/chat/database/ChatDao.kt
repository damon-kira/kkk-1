...
// app/src/main/java/com/example/ai/chatdemo/database/ChatDao.kt
@Dao
interface ChatDao {
    // 获取所有聊天记录（按时间倒序）
...
// app/src/main/java/com/example/ai/chatdemo/database/AppDatabase.kt
//@Database(
...
//                    context.applicationContext, AppDatabase::class.java, "chat_database"
//                ).build()
//                INSTANCE = instance
//                instance
//            }
