...
package com.kira.ui.language.fortran.provider
...
class FortranProvider private constructor() : SuggestionProvider {

    companion object {

        private var fortranProvider: FortranProvider? = null

        fun getInstance(): FortranProvider {
            return fortranProvider ?: FortranProvider().also {
                fortranProvider = it
            }
        }
    }
