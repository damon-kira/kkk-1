...
package com.kira.ui.language.yaml.provider
...
class YamlProvider private constructor() : SuggestionProvider {

    companion object {

        private var yamlProvider: YamlProvider? = null

        fun getInstance(): YamlProvider {
            return yamlProvider ?: YamlProvider().also {
                yamlProvider = it
            }
        }
    }
