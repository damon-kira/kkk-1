package com.kira.learning.xml.view.baseinfo
...
import com.kira.learning.databinding.LayoutEmailViewBinding
import com.kira.learning.xml.expand.errorImageSpan
...
class EmailInfoView @JvmOverloads constructor(
    ...
    private lateinit var mBinding: LayoutEmailViewBinding

    override fun init(context: Context?, attrs: AttributeSet?) {
        context ?: return
        mBinding = LayoutEmailViewBinding.inflate(LayoutInflater.from(context), this)
        ...
        mBinding.bivEdittext.dropDownVerticalOffset = 4
    }
    ...
    override fun setTextArray(array: ArrayList<String>) {
        mBinding.bivEdittext.setListData(array)
    }
