package com.kira.ui.language.xml.provider
...
class XmlProvider private constructor() : SuggestionProvider {

    companion object {

        private var xmlProvider: XmlProvider? = null

        fun getInstance(): XmlProvider {
            return xmlProvider ?: XmlProvider().also {
                xmlProvider = it
            }
        }
    }
