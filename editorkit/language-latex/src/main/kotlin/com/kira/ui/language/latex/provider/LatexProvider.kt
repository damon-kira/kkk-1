...
package com.kira.ui.language.latex.provider
...
class LatexProvider private constructor() : SuggestionProvider {

    companion object {

        private var latexProvider: LatexProvider? = null

        fun getInstance(): LatexProvider {
            return latexProvider ?: LatexProvider().also {
                latexProvider = it
            }
        }
    }
